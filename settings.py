# Django settings for recipecenter project.
import os
DEBUG = False
...
DATABASES = {
    'default': {
        ...
        'NAME': 'recipe.db',                      # Or path to database file if using sqlite3.
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'recipecenter.in']
...
MEDIA_ROOT = os.path.join(os.path.dirname(__file__), 'static_media')
...
SECRET_KEY = '9hk2b0p=4+**cq0!=mn7)!3dz1s(w=-&ceq#fvv_&5!b507e)t'
